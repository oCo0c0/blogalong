...
import static run.blog.app.extension.router.selector.Operator.Equals;
import static run.blog.app.extension.router.selector.Operator.Exist;
import static run.blog.app.extension.router.selector.Operator.IN;
import static run.blog.app.extension.router.selector.Operator.NotEquals;
import static run.blog.app.extension.router.selector.Operator.NotExist;
