...
import run.blog.app.infra.ConditionList;
...
public class Post extends AbstractExtension {
    ...
    public static final String CATEGORIES_ANNO = "content.blog.run/categories";
    public static final String LAST_RELEASED_SNAPSHOT_ANNO =
        "content.blog.run/last-released-snapshot";
    public static final String LAST_ASSOCIATED_TAGS_ANNO = "content.blog.run/last-associated-tags";

    public static final String DELETED_LABEL = "content.blog.run/deleted";
    public static final String PUBLISHED_LABEL = "content.blog.run/published";
    public static final String OWNER_LABEL = "content.blog.run/owner";
    public static final String VISIBLE_LABEL = "content.blog.run/visible";

    public static final String ARCHIVE_YEAR_LABEL = "content.blog.run/archive-year";

    public static final String ARCHIVE_MONTH_LABEL = "content.blog.run/archive-month";
    public static final String ARCHIVE_DAY_LABEL = "content.blog.run/archive-day";
