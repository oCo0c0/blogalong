...
import static run.blog.app.core.extension.Role.GROUP;
import static run.blog.app.core.extension.Role.KIND;
import static run.blog.app.core.extension.Role.VERSION;
...
public class Role extends AbstractExtension {
    public static final String ROLE_DEPENDENCY_RULES =
        "rbac.authorization.blog.run/dependency-rules";
    public static final String ROLE_AGGREGATE_LABEL_PREFIX =
        "rbac.authorization.blog.run/aggregate-to-";
    public static final String ROLE_DEPENDENCIES_ANNO = "rbac.authorization.blog.run/dependencies";
    public static final String UI_PERMISSIONS_ANNO = "rbac.authorization.blog.run/ui-permissions";

    public static final String SYSTEM_RESERVED_LABELS =
        "rbac.authorization.blog.run/system-reserved";
    public static final String HIDDEN_LABEL_NAME = "blog.run/hidden";
    public static final String TEMPLATE_LABEL_NAME = "blog.run/role-template";
    public static final String UI_PERMISSIONS_AGGREGATED_ANNO =
        "rbac.authorization.blog.run/ui-permissions-aggregated";
