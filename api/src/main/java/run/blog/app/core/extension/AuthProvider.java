...
@GVK(group = "auth.blog.run", version = "v1alpha1", kind = "AuthProvider",
    singular = "authprovider", plural = "authproviders")
public class AuthProvider extends AbstractExtension {

    public static final String AUTH_BINDING_LABEL = "auth.blog.run/auth-binding";
    
    public static final String PRIVILEGED_LABEL = "auth.blog.run/privileged";
