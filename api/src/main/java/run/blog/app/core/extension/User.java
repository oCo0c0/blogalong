...
import static run.blog.app.core.extension.User.VERSION;
...
/**
 * The extension represents user details of Blog.
 *
 * @author johnniang
 */
@Data
...
public class User extends AbstractExtension {
    ...
    public static final String ROLE_NAMES_ANNO = "rbac.authorization.blog.run/role-names";

    public static final String EMAIL_TO_VERIFY = "blog.run/email-to-verify";

    public static final String LAST_AVATAR_ATTACHMENT_NAME_ANNO =
        "blog.run/last-avatar-attachment-name";

    public static final String AVATAR_ATTACHMENT_NAME_ANNO = "blog.run/avatar-attachment-name";

    public static final String HIDDEN_USER_LABEL = "blog.run/hidden-user";
