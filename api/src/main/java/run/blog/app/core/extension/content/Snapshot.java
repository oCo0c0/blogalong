...
public class Snapshot extends AbstractExtension {
    ...
    public static final String KEEP_RAW_ANNO = "content.blog.run/keep-raw";
    public static final String PATCHED_CONTENT_ANNO = "content.blog.run/patched-content";
    public static final String PATCHED_RAW_ANNO = "content.blog.run/patched-raw";
