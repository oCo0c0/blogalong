package run.blog.app.core.extension.notification;
...
import run.blog.app.notification.ReasonAttributes;
...
@GVK(group = "notification.blog.run", version = "v1alpha1", kind = "Reason", plural =
