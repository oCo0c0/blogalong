...
import static run.blog.app.core.extension.RoleBinding.GROUP;
import static run.blog.app.core.extension.RoleBinding.KIND;
import static run.blog.app.core.extension.RoleBinding.VERSION;
...
public class RoleBinding extends AbstractExtension {
    ...
    public static class Subject {
         ...
         * Defaults to "rbac.authorization.blog.run" for User and Group subjects.
         */
        String apiGroup;
