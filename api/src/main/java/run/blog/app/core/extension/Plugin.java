...
@GVK(group = "plugin.blog.run", version = "v1alpha1", kind = "Plugin", plural = "plugins",
    singular = "plugin")
...
public class Plugin extends AbstractExtension {
    ...
    /**
     * In the future, we may consider using {@link run.blog.app.infra.model.License} instead of it.
