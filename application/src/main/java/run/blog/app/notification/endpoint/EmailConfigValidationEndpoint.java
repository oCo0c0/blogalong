...
import run.blog.app.notification.EmailSenderHelper;
...
public class EmailConfigValidationEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        var tag = "console.api.notification.blog.run/v1alpha1/Notifier";
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("console.api.notification.blog.run/v1alpha1");
    }
}
