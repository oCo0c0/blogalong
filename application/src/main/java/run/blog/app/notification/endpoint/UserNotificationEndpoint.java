...
import run.blog.app.notification.UserNotificationQuery;
import run.blog.app.notification.UserNotificationService;
...
public class UserNotificationEndpoint implements CustomEndpoint {
    ...
    Supplier<RouterFunction<ServerResponse>> userspaceScopedApis() {
        var tag = "api.notification.blog.run/v1alpha1/Notification";
        return () -> SpringdocRouteBuilder.route()
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("api.notification.blog.run/v1alpha1");
    }
