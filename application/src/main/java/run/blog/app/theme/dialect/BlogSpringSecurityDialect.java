...
/**
 * BlogSpringSecurityDialect overwrites value of thymeleafSpringSecurityContext.
 *
 * @author johnniang
 */
public class BlogSpringSecurityDialect extends SpringSecurityDialect {
    ...
    public BlogSpringSecurityDialect(ServerSecurityContextRepository securityContextRepository) {
