 ...
 */
@Component
public class BlogTrackerProcessor implements TemplateHeadProcessor {

    private final ExternalUrlSupplier externalUrlGetter;

    public BlogTrackerProcessor(ExternalUrlSupplier externalUrlGetter) {
    ...
    private String trackerScript(String externalUrl, String group, String plural, String name) {
        String jsSrc = PathUtils.combinePath(externalUrl, "/blog-tracker.js");
        return """
