...
import run.blog.app.theme.dialect.BlogProcessorDialect;
import run.blog.app.theme.engine.BlogTemplateEngine;
import run.blog.app.theme.engine.PluginClassloaderTemplateResolver;
import run.blog.app.theme.message.ThemeMessageResolver;
...
public class TemplateEngineManager {
    ...
    public TemplateEngineManager(ThymeleafProperties thymeleafProperties,
        ...
        BlogPluginManager blogPluginManager, ObjectProvider<ITemplateResolver> templateResolvers,
        ObjectProvider<IDialect> dialects, ThemeResolver themeResolver) {
        this.thymeleafProperties = thymeleafProperties;
        this.externalUrlSupplier = externalUrlSupplier;
        this.blogPluginManager = blogPluginManager;
    ...
    private ISpringWebFluxTemplateEngine templateEngineGenerator(CacheKey cacheKey) {
        ...
        var engine = new BlogTemplateEngine(new ThemeMessageResolver(cacheKey.context()));
        ...
        var mainResolver = blogTemplateResolver();
        ...
        engine.addDialect(new BlogProcessorDialect());
    ...
    private PluginClassloaderTemplateResolver createPluginClassloaderTemplateResolver() {
        var pluginTemplateResolver = new PluginClassloaderTemplateResolver(blogPluginManager);
    ...
    FileTemplateResolver blogTemplateResolver() {
