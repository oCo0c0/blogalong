...
/**
 * Default template engine implementation to be used in Blog.
 *
 * @author johnniang
 */
public class BlogTemplateEngine extends SpringWebFluxTemplateEngine {

    private final IMessageResolver messageResolver;

    public BlogTemplateEngine(IMessageResolver messageResolver) {
