...
import run.blog.app.theme.dialect.GeneratorMetaProcessor;
import run.blog.app.theme.dialect.BlogSpringSecurityDialect;
import run.blog.app.theme.dialect.LinkExpressionObjectDialect;
import run.blog.app.theme.dialect.TemplateHeadProcessor;
...
public class ThemeConfiguration {
    ...
    SpringSecurityDialect springSecurityDialect(
        ...
        return new BlogSpringSecurityDialect(securityContextRepository);
    }

    @Bean
    @ConditionalOnProperty(name = "blog.theme.generator-meta-disabled",
        havingValue = "false",
        matchIfMissing = true)
