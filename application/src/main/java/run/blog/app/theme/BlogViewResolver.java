...
public class BlogViewResolver extends ThymeleafReactiveViewResolver {

    private final FinderRegistry finderRegistry;

    public BlogViewResolver(FinderRegistry finderRegistry) {
        setViewClass(BlogView.class);
    ...
    public static class BlogView extends ThymeleafReactiveView {
