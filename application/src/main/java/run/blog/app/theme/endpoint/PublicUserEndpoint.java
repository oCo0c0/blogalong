...
import run.blog.app.core.extension.service.EmailPasswordRecoveryService;
...
import run.blog.app.infra.exception.EmailVerificationFailed;
...
public class PublicUserEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        var tag = "api.blog.run/v1alpha1/User";
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("api.blog.run/v1alpha1");
    }
