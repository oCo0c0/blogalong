...
public class UcPostAttachmentEndpoint implements CustomEndpoint {
    ...
    public static final String POST_NAME_LABEL = "content.blog.run/post-name";
    public static final String SINGLE_PAGE_NAME_LABEL = "content.blog.run/single-page-name";
