package run.blog.app.endpoint.uc.content;
...
import run.blog.app.content.Content;
import run.blog.app.content.ListedPost;
import run.blog.app.content.PostQuery;
import run.blog.app.content.PostRequest;
import run.blog.app.content.PostService;
import run.blog.app.content.SnapshotService;
...
public class UcPostEndpoint implements CustomEndpoint {
    ...
    private static final String CONTENT_JSON_ANNO = "content.blog.run/content-json";
                ...
                () -> route()
                    ...
                    .POST(this::createMyPost, builder -> builder.operationId("CreateMyPost")
                        ...
                        .description("""
                            Create my post. If you want to create a post with content, please set
                             annotation: "content.blog.run/content-json" into annotations and refer
                    ...
                    .PUT("/{name}/draft", this::updateMyPostDraft, builder -> builder.tag(tag)
                        ...
                        .description("""
                            ...
                            "content.blog.run/content-json" into annotations and refer to 
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("uc.api.content.blog.run/v1alpha1");
    }
