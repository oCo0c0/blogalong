...
/**
 * BlogAnonymousAuthenticationWebFilter will save SecurityContext into SecurityContextRepository
 * when AnonymousAuthenticationToken is created.
 *
 * @author johnniang
 */
public class BlogAnonymousAuthenticationWebFilter extends AnonymousAuthenticationWebFilter {

    private final ServerSecurityContextRepository securityContextRepository;

    public BlogAnonymousAuthenticationWebFilter(String key, Object principal,
