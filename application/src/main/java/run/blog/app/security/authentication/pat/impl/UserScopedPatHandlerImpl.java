package run.blog.app.security.authentication.pat.impl;

import static run.blog.app.extension.Comparators.compareCreationTimestamp;
import static run.blog.app.security.authentication.pat.PatServerWebExchangeMatcher.PAT_TOKEN_PREFIX;
...
import run.blog.app.extension.exception.ExtensionNotFoundException;
...
import run.blog.app.security.authentication.pat.UserScopedPatHandler;
...
public class UserScopedPatHandlerImpl implements UserScopedPatHandler {
    ...
    private static final String ACCESS_TOKEN_ANNO_NAME = "security.blog.run/access-token";
