package run.blog.app.security.authentication.twofactor;
...
import run.blog.app.infra.exception.RequestBodyValidationException;
import run.blog.app.security.authentication.twofactor.totp.TotpAuthService;
...
public class TwoFactorAuthEndpoint implements CustomEndpoint {
    ...
    public GroupVersion groupVersion() {
        return GroupVersion.parseAPIVersion("api.security.blog.run/v1alpha1");
    }
}
