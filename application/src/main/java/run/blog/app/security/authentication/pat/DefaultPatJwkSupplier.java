...
public class DefaultPatJwkSupplier implements PatJwkSupplier {
    ...
    public DefaultPatJwkSupplier(BlogProperties blogProperties) throws JOSEException {
        var keyPair = getRsaKeyPairOrCreate(blogProperties);
    ...
    private KeyPair getRsaKeyPairOrCreate(BlogProperties blogProperties) {
        var keysRoot = blogProperties.getWorkDir().resolve("keys");
