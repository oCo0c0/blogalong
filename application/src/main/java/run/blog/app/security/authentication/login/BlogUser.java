...
public class BlogUser implements UserDetails, CredentialsContainer {
    ...
    public BlogUser(User delegate, Collection<? extends GrantedAuthority> authorities) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BlogUser user) {
    ...
    public static class Builder {
        ...
        public BlogUser build() {
            return new BlogUser(user, authorities);
        }
    }
}
