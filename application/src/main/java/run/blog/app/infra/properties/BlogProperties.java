...
@Validated
public class BlogProperties implements Validator {
     ...
     * See {@link run.blog.app.infra.ExtensionResourceInitializer#REQUIRED_EXTENSION_LOCATIONS}
     * for more.
     */
    ...
    public boolean supports(Class<?> clazz) {
        return BlogProperties.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        var props = (BlogProperties) target;
