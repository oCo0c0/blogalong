package run.blog.app.infra.exception.handlers;
...
import run.blog.app.theme.ThemeResolver;
import run.blog.app.theme.engine.ThemeTemplateAvailabilityProvider;

public class BlogErrorWebExceptionHandler extends DefaultErrorWebExceptionHandler {
     ...
     * @since 2.4.0
     */
    public BlogErrorWebExceptionHandler(
