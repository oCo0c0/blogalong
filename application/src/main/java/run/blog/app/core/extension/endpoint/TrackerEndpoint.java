...
import run.blog.app.event.post.DownvotedEvent;
import run.blog.app.event.post.UpvotedEvent;
import run.blog.app.event.post.VisitedEvent;
...
public class TrackerEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        final var tag = "api.blog.run/v1alpha1/Tracker";
    ...
    public GroupVersion groupVersion() {
        return new GroupVersion("api.blog.run", "v1alpha1");
    }
}
