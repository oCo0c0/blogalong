...
import static run.blog.app.core.extension.theme.ThemeUtils.loadThemeManifest;
import static run.blog.app.core.extension.theme.ThemeUtils.locateThemeManifest;
import static run.blog.app.core.extension.theme.ThemeUtils.unzipThemeTo;
import static run.blog.app.infra.utils.FileUtils.createTempDir;
import static run.blog.app.infra.utils.FileUtils.deleteRecursivelyAndSilently;
import static run.blog.app.infra.utils.FileUtils.unzip;
...
import run.blog.app.infra.ThemeRootGetter;
import run.blog.app.infra.exception.ThemeUpgradeException;
...
public class ThemeServiceImpl implements ThemeService {
    ...
    public Mono<Theme> upgrade(String themeName, Publisher<DataBuffer> content) {
        ...
        var upgradeTheme = Mono.usingWhen(
            createTempDir("blog-theme-", scheduler),
            tempDir -> {
