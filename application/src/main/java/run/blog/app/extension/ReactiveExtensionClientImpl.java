...
import run.blog.app.extension.index.DefaultExtensionIterator;
import run.blog.app.extension.index.ExtensionIterator;
    ...
    public <E extends Extension> Mono<E> create(E extension) {
        ...
        return Mono.just(extension)
            .doOnNext(ext -> {
                ...
                // those fields should be managed by blog.
