 ...
 */
@Slf4j
public class BlogPluginManager extends DefaultPluginManager implements SpringPluginManager {
    ...
    public BlogPluginManager(ApplicationContext rootContext,
    ...
    protected PluginWrapper createPluginWrapper(PluginDescriptor pluginDescriptor, Path pluginPath,
        ...
        var pluginWrapper =
            new BlogPluginWrapper(this, pluginDescriptor, pluginPath, pluginClassLoader);
