 ...
 * from {@code blog.plugin.enabled-plugins} properties in <code>application.yaml</code>
 * and the disabled plugins are read from {@code blog.plugin.disabled-plugins}
