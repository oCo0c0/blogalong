package run.blog.app.plugin.extensionpoint;
 ...
 * An {@link ExtensionPointDefinition} is a concept used in <code>Blog</code> to allow for the
 * dynamic extension of system. It defines a location within <code>Blog</code> where
...
@GVK(group = "plugin.blog.run", version = "v1alpha1",
