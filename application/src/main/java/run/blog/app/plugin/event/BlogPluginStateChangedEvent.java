 ...
 * @date 2021-11-06
 */
public class BlogPluginStateChangedEvent extends ApplicationEvent {

    private final PluginWrapper plugin;

    private final PluginState oldState;

    public BlogPluginStateChangedEvent(Object source, PluginWrapper wrapper, PluginState oldState) {
        super(source);
        this.plugin = wrapper;
