...
import static run.blog.app.plugin.resources.BundleResourceUtils.getJsBundleResource;
...
public class PluginAutoConfiguration {
    ...
    public PluginManager pluginManager(ApplicationContext context,
        ...
        return new BlogPluginManager(context, pluginProperties, systemVersionSupplier);
    }
