...
class DefaultExternalLinkProcessorTest {
    ...
    void process() throws MalformedURLException {
        ...
        when(externalUrlSupplier.getRaw()).thenReturn(URI.create("https://blog.run").toURL());
        assertThat(externalLinkProcessor.processLink("/test")).isEqualTo("https://blog.run/test");
