...
class PluginRequestMappingHandlerMappingTest {
        ...
        assertThat(info.getPatternsCondition().getPatterns()).isEqualTo(
            Collections.singleton(
                new PathPatternParser().parse(
                    "/apis/api.plugin.blog.run/v1alpha1/plugins/fakePlugin/user/{id}")));
    }
    ...
    void registerHandlerMethods() {
        ...
        assertThat(mappings.get(0).toString()).isEqualTo(
            "{GET /apis/api.plugin.blog.run/v1alpha1/plugins/fakePlugin/user/{id}}");
    }
    ...
    public void getHandlerDirectMatch() {
        ...
        ServerWebExchange exchange =
            MockServerWebExchange.from(
                get("/apis/api.plugin.blog.run/v1alpha1/plugins/fakePlugin/foo"));
    ...
    public void getHandlerBestMatch() {
        ...
        String requestPath = "/apis/api.plugin.blog.run/v1alpha1/plugins/fakePlugin/foo?p=anything";
    ...
    public void getHandlerRootPathMatch() {
        ...
        String requestPath = "/apis/api.plugin.blog.run/v1alpha1/plugins/fakePlugin";
        ServerWebExchange exchange = MockServerWebExchange.from(get(requestPath));
        HandlerMethod hm = (HandlerMethod) this.handlerMapping.getHandler(exchange).block();
    ...
    public void getHandlerRequestMethodNotAllowed() {
        ...
        String requestPath = "/apis/api.plugin.blog.run/v1alpha1/plugins/fakePlugin/bar";
    ...
    void buildPrefix() {
        ...
        assertThat(s).isEqualTo("/apis/api.plugin.blog.run/v1/plugins/fakePlugin");

        s = handlerMapping.buildPrefix("fakePlugin", "fake.blog.run/v1alpha1");
        assertThat(s).isEqualTo("/apis/fake.blog.run/v1alpha1");
    }
