...
import run.blog.app.theme.TemplateEngineManager;
...
class ThemeEndpointTest {
    ...
    void setUp() throws IOException {
        tmpBlogWorkDir = Files.createTempDirectory("blog-theme-endpoint-test");
        lenient().when(themeRoot.get()).thenReturn(tmpBlogWorkDir);
    ...
    void tearDown() throws IOException {
        FileSystemUtils.deleteRecursively(tmpBlogWorkDir);
    }
