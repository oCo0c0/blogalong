...
public class UserEndpointIntegrationTest {
    ...
    class UserListTest {
        ...
        void shouldFilterUsersWhenDisplayNameKeywordProvided() {
            ...
            webClient.get().uri("/apis/api.console.blog.run/v1alpha1/users?keyword=Expected")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
        ...
        void shouldFilterUsersWhenUserNameKeywordProvided() {
            ...
            webClient.get().uri("/apis/api.console.blog.run/v1alpha1/users?keyword=fake-user")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.items.length()").isEqualTo(1)
