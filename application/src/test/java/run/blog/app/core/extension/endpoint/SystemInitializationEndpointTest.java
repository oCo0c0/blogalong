...
import run.blog.app.core.extension.endpoint.SystemInitializationEndpoint.SystemInitializationRequest;
...
import run.blog.app.security.SuperAdminInitializer;
import run.blog.app.security.SuperAdminInitializer.InitializationParam;
...
class SystemInitializationEndpointTest {
    ...
    void initializeWithRequestBody() {
        ...
        initialization.setEmail("faker@blog.run");
