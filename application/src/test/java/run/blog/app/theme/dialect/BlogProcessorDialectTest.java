...
import run.blog.app.theme.finders.SinglePageFinder;
...
/**
 * Tests for {@link BlogProcessorDialect}.
 *
 * @author guqing
 * @see BlogProcessorDialect
...
class BlogProcessorDialectTest {
    @Mock
    ...
    @BeforeEach
    void setUp() {
        BlogProcessorDialect blogProcessorDialect = new BlogProcessorDialect();
        templateEngine = new TemplateEngine();
        templateEngine.setDialects(Set.of(blogProcessorDialect, new SpringStandardDialect()));
