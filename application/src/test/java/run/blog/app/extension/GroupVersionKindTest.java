...
class GroupVersionKindTest {
    ...
    void testFromApiVersionAndKind() {
        ...
        List.of(
            ...
            new TestCase("fake.blog.run/v1alpha1", "Fake",
                new GroupVersionKind("fake.blog.run", "v1alpha1", "Fake"), null),
            ...
            new TestCase("fake.blog.run/v1alpha1/v1alpha2", "Fake", null,
    ...
    void testHasGroup() {
        ...
        List.of(
            ...
            new TestCase(new GroupVersionKind("fake.blog.run", "v1alpha1", "Fake"), true)
    ...
    void testGroupKind() {
        ...
        List.of(
            ...
            new TestCase(new GroupVersionKind("fake.blog.run", "v1alpha1", "Fake"),
                new GroupKind("fake.blog.run", "Fake"))
        ).forEach(testCase -> {
    ...
    void testGroupVersion() {
        ...
        List.of(
            ...
            new TestCase(new GroupVersionKind("fake.blog.run", "v1alpha1", "Fake"),
                new GroupVersion("fake.blog.run", "v1alpha1"))
        ).forEach(testCase -> {
    ...
    void fromExtension() {
        ...
        assertEquals("fake.blog.run", groupVersionKind.group());
