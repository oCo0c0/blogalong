...
class ExtensionStoreUtilTest {
    ...
    void setUp() {
        scheme = new Scheme(FakeExtension.class,
            new GroupVersionKind("fake.blog.run", "v1alpha1", "Fake"),
            "fakes",
            "fake",
            new ObjectNode(null));
    ...
    void buildStoreNamePrefix() {
        ...
        assertEquals("/registry/fake.blog.run/fakes", prefix);
    ...
    void buildStoreName() {
        ...
        assertEquals("/registry/fake.blog.run/fakes/fake-name", storeName);
