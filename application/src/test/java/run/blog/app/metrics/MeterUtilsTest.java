...
class MeterUtilsTest {
    ...
    void nameOf() {
        ...
        assertThat(s).isEqualTo("posts.content.blog.run/fake-post");
    }

    @Test
    void testNameOf() {
        String s = MeterUtils.nameOf("content.blog.run", "posts", "fake-post");
        assertThat(s).isEqualTo("posts.content.blog.run/fake-post");
    }
    ...
    void visitCounter() {
        ...
        MeterUtils.visitCounter(meterRegistry, "posts.content.blog.run/fake-post")
            .increment();
        RequiredSearch requiredSearch = meterRegistry.get("posts.content.blog.run/fake-post");
    ...
    void upvoteCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        MeterUtils.upvoteCounter(meterRegistry, "posts.content.blog.run/fake-post")
            .increment(2);
        RequiredSearch requiredSearch = meterRegistry.get("posts.content.blog.run/fake-post");
    ...
    void totalCommentCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        MeterUtils.totalCommentCounter(meterRegistry, "content.blog.run.posts.fake-post")
            .increment(3);
        RequiredSearch requiredSearch = meterRegistry.get("content.blog.run.posts.fake-post");
    ...
    void approvedCommentCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        MeterUtils.approvedCommentCounter(meterRegistry, "posts.content.blog.run/fake-post")
            .increment(2);
        RequiredSearch requiredSearch = meterRegistry.get("posts.content.blog.run/fake-post");
        assertThat(requiredSearch.counter().count()).isEqualTo(2);
        Meter.Id id = requiredSearch.counter().getId();
    ...
    void isDownvoteCounter() {
        ...
        Counter downvoteCounter =
            MeterUtils.downvoteCounter(meterRegistry, "posts.content.blog.run/fake-post");
    ...
    void isTotalCommentCounter() {
        ...
        Counter totalCommentCounter =
            MeterUtils.totalCommentCounter(meterRegistry, "posts.content.blog.run/fake-post");
