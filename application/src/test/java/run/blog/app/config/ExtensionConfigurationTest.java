...
class ExtensionConfigurationTest {
    ...
    void shouldReturnNotFoundWhenSchemeNotRegistered() {
        ...
        webClient.get()
            .uri("/apis/fake.blog.run/v1alpha1/fakes")
            .exchange()
            .expectStatus().isNotFound();

        webClient.get()
            .uri("/apis/fake.blog.run/v1alpha1/fakes/my-fake")
            .exchange()
            .expectStatus().isNotFound();
    ...
    class AfterCreatingExtension {
        ...
        void setUp() {
            ...
            webClient.get()
                .uri("/apis/fake.blog.run/v1alpha1/fakes/{}", metadata.getName())
                .exchange()
                .expectStatus().isNotFound();
            ...
            createdFake = webClient.post()
                ...
                .expectHeader().location("/apis/fake.blog.run/v1alpha1/fakes/my-fake")
        ...
        void shouldDeleteExtensionWhenSchemeRegistered() {
            webClient.delete()
                .uri("/apis/fake.blog.run/v1alpha1/fakes/{name}",
        ...
        void shouldListExtensionsWhenSchemeRegistered() {
            webClient.get().uri("/apis/fake.blog.run/v1alpha1/fakes")
                .exchange()
                .expectStatus().isOk()
        ...
        void shouldListExtensionsWithMatchedSelectors() {
            webClient.get().uri(uriBuilder -> uriBuilder
                    .path("/apis/fake.blog.run/v1alpha1/fakes")
        ...
        void shouldUpdateExtensionWhenSchemeRegistered() {
            ...
            webClient.put()
                .uri("/apis/fake.blog.run/v1alpha1/fakes/{name}", name)
