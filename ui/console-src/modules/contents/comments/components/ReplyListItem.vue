...
import type { ListedReply } from "@blogalong/api-client";
...
const handleDelete = async () => {
  Dialog.warning({
    ...
    onConfirm: async () => {
      try {
        await apiClient.extension.reply.deletecontentBlogRunV1alpha1Reply({
...
const handleApprove = async () => {
  try {
    ...
    await apiClient.extension.reply.updatecontentBlogRunV1alpha1Reply({
