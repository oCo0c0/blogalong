...
const handleDelete = async () => {
  Dialog.warning({
    ...
    onConfirm: async () => {
      try {
        await apiClient.extension.comment.deletecontentBlogRunV1alpha1Comment({
    ...
    onConfirm: async () => {
      try {
        ...
        const promises = repliesToUpdate?.map((reply) => {
          return apiClient.extension.reply.updatecontentBlogRunV1alpha1Reply({
...
const handleApprove = async () => {
  try {
    ...
    await apiClient.extension.comment.updatecontentBlogRunV1alpha1Comment({
