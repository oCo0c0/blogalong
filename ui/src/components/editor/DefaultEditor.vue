...
} from "@blogalong/richtext-editor";
// ui custom extension
import {
  UiExtensionAudio,
  UiExtensionImage,
...
import type { AttachmentLike, PluginModule } from "@blogalong/console-shared";
...
declare module "@blogalong/richtext-editor" {
...
const showSidebar = useLocalStorage("blog:editor:show-sidebar", true);
