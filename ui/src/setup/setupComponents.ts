...
import { VClosePopper, VLoading, VTooltip } from "@blogalong/components";
...
export function setupComponents(app: App) {
  ...
  // @deprecated
  // Will be removed in the future, please use the VDropdown component from @blogalong/components.
